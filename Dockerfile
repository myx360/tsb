...
WORKDIR /build/rest_app

RUN mkdir target
RUN mvn package -U -DskipTests
RUN mv target/rest_app-0.0.1-SNAPSHOT.jar /build/app.jar
...
# eclipse-temurin@sha256:99cede493dfd88720b610eb8077c8688 d3cca50003d76d1d539b0efc8cca72b4.
